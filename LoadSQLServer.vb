...
Public Class LoadSQLServer
    ...
    Public Function GetCommandProc(strProcName As String, strDataBase As SqlConnection) As SqlCommand
        Dim scmdCMD As SqlCommand
        Try


            scmdCMD = New SqlCommand
            scmdCMD.Connection = strDataBase
    ...
    Public Function GetCommandStr(strSQLString As String, strDataBase As SqlConnection) As SqlCommand
        Dim scmdCMD As SqlCommand
        Try
    ...
    ''' <remarks></remarks>
    Public Function ReturnFormat(ByVal strTable As String, strDataBase As SqlConnection) As DataTable
        ...
        adaptData = New SqlDataAdapter("SELECT top 1 * from " & strTable & ";", strDataBase)
    ...
    Public Function BlukInsert(ByVal strTable As String, ByVal dtData As DataTable, strDataBase As SqlConnection) As Integer
        Dim sbcBulkInsert As SqlBulkCopy


        strDataBase.Open()
        sbcBulkInsert = New SqlBulkCopy(strDataBase)
